...
// core/parser.js - Rescale AI command parsing. PURE string logic, zero DOM:
...
const ZSParse = (() => {
  ...
  // new Rescale AI schema ("command"/"params") and the legacy/function-calling
  ...
  // The assistant emitted a Rescale AI command (JSON or a ###LUA### block).
